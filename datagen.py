...
def test():
    ...
    dataset = ListDataset(root='./data/af2019-cv-training-20190312',
                       list_file='./data/find_star_txt_folder/find_star_train_bbx_gt.txt', train=True, transform=transform, input_size=832)
